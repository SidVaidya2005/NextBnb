...
export function Button({
  ...
  return (
    <button
      className={`press inline-flex items-center justify-center gap-2 whitespace-nowrap font-sans cursor-pointer rounded-sm ${sizeStyles[size]} ${variantStyles[variant]} ${className}`}
      {...rest}
    >
      {children}
    </button>
